...
class cfgWeapons
{
	...
	class IMP_SVD: IMP_SVD_Base
	{
		scope=2;
		displayName="$STR_IMP_SVDNAME";
		descriptionShort="$STR_IMP_SVDRaptdescr";
		model="\IMPWMOD\Weapons\Sniper\SVD\models\IMP_SVD.p3d";
		attachments[]=
		{
			"weaponWrap",
			"weaponOpticsAK",
		...
		{
			"IMPWMOD\Weapons\Sniper\SVD\data\SVD_co.paa"
		};
		class DamageSystem
		{
			class GlobalHealth

...
class CfgMagazines 
{
	...
	{
		scope = 2;
		displayName = "$STR_IMP_12742";
		descriptionShort = "$STR_IMP_127421";
		model = "IMPWMOD\Weapons\Ammo\127x42\models\127x42.p3d";
		iconCartridge = 2;
		weight = 4;
		count = 15;
		itemSize[]={2,3};
...
{
	class Box_Base;
	class IMP_AmmoBox_127x42_100Rnd: Box_Base
	{
		scope=2;
		displayName="$STR_IMP_Ammobox12742";
		descriptionShort="";
		...
		hiddenSelectionsTextures[] = {"IMPWMOD\Weapons\Ammo\AmmoBox\127x42_box_co.paa"};
		weight=185;
		class DamageSystem
		{
			class GlobalHealth
	...
	class IMP_AmmoBox_127x42_15Rnd: Box_Base
	{
		scope=2;
		displayName="$STR_IMP_Ammobox12742";
		descriptionShort="";

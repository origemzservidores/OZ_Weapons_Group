...
class CfgMagazines 
{
	...
	{
		scope = 2;
		displayName = "$STR_IMP_79257";
		descriptionShort = "";
		model = "IMPWMOD\Weapons\Ammo\792x57\models\792x57.p3d";
		iconCartridge = 2;
		weight = 4;
		count = 20;
		itemSize[]={1,2};
		ammo = "IMP_Bullet_792x57";
...
{
	class Box_Base;
	class IMP_AmmoBox_792x57_100Rnd: Box_Base
	{
		scope=2;
		displayName="$STR_IMP_box79257";
		descriptionShort="";
		...
		hiddenSelectionsTextures[] = {"IMPWMOD\Weapons\Ammo\AmmoBox\792x57_box_co.paa"};
		weight=185;
		class DamageSystem
		{
			class GlobalHealth
	...
	class IMP_AmmoBox_792x57_20Rnd: Box_Base
	{
		scope=2;
		displayName="$STR_IMP_box79257";
		descriptionShort="";

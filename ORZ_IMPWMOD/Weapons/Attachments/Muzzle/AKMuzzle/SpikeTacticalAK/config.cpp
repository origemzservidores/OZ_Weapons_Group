class CfgPatches {
	class IMP_Muzzle_AK_SpikeTacticalAK
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
class cfgVehicles 
{
    ...
    {
		scope=2;
		displayName="AK SpikeTactical";
		descriptionShort="$STR_IMP_MuzzleDescr";
		model="IMPWMOD\Weapons\Attachments\Muzzle\AKMuzzle\SpikeTacticalAK\models\SpikeTacticalAK.p3d";
		soundIndex=0;
		rotationFlags=17;
		reversed=0;
		weight=400;

class CfgPatches {
	class IMP_Muzzle_AK_VenomAntidote 
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
class cfgVehicles 
{
    ...
    {
		scope=2;
		displayName="AK Venom Antidote";
		descriptionShort="$STR_IMP_MuzzleDescr";
		model="IMPWMOD\Weapons\Attachments\Muzzle\AKMuzzle\VenomAntidote\models\VenomAntidote.p3d";
		soundIndex=0;
		rotationFlags=17;
		reversed=0;
		weight=400;

class CfgPatches {
	class IMP_Muzzle_AK_AKTulaMuzzle 
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
class cfgVehicles 
{
    ...
    {
		scope=2;
		displayName="$STR_IMP_Muzzleantula";
		descriptionShort="$STR_IMP_MuzzleDescr";
		model="IMPWMOD\Weapons\Attachments\Muzzle\AKMuzzle\AKTulaMuzzle\models\AKTulaMuzzle.p3d";
		soundIndex=0;
		rotationFlags=17;
		reversed=0;
		weight=400;

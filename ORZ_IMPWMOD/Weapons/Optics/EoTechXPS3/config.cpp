class CfgPatches
{
	class IMP_Optic_EoTech_XPS3
	{
		units[]={"IMP_Optic_EoTech_XPS3"};
		weapons[]={};
		requiredVersion=0.1;
		requiredAddons[]=
		{
...
class cfgVehicles {
	...
	class IMP_Optic_EoTech_XPS3_Base: ItemOptics
	{
		...
		model="\IMPWMOD\Weapons\Optics\EoTechXPS3\models\XPS3.p3d";
	...
	class IMP_Optic_EoTech_XPS3: IMP_Optic_EoTech_XPS3_Base
	{
		scope = 2;
		hiddenSelections[]=
		{

class CfgPatches
{
	class IMP_Optic_HoloScope
	{
		units[]={"IMP_Optic_HoloScope"};
		weapons[]={};
		requiredVersion=0.1;
		requiredAddons[]=
		{
...
class cfgVehicles {
	...
	class IMP_Optic_HoloScope_Base: ItemOptics
	{
		...
		repairCosts[]={25};
		displayName="HoloScope";
		descriptionShort="$STR_IMP_Collimator";
		model="\IMPWMOD\Weapons\Optics\HoloScope\models\HoloScope.p3d";
	...
	class IMP_Optic_HoloScope: IMP_Optic_HoloScope_Base
	{
		scope = 2;
		hiddenSelections[]=
		{

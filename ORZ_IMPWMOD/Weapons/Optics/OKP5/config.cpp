...
class cfgVehicles {
	...
	class IMP_Optic_OKP5_Base: ItemOptics
	{
		...
		model="\IMPWMOD\Weapons\Optics\OKP5\models\OKP5.p3d";
		...
		{
			"",
			"IMPWMOD\Weapons\Optics\OKP7\data\scope_all_ekb_okp7_LOD0_co.paa"
		};
		class DamageSystem {
			class GlobalHealth {
				class Health {
	...
	class IMP_Optic_OKP5: IMP_Optic_OKP5_Base
	{
		scope = 2;
		hiddenSelections[]=
		{
